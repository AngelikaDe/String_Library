...
START_TEST(s21_strncmp_test) {
  ...
  char second_3[] = "62345";
  res = strncmp(first_3, second_3, 5);
  res_orig = strncmp(first_3, second_3, 5);
  ck_assert_int_eq(res, res_orig);
}
END_TEST
...
START_TEST(s21_strncat_test) {
  ...
  char str_2[40] = "";
  char str_3[40] = "";
  ck_assert_str_eq(strncat(str_2, "YYEEEEEAHhhh", 6),
                   s21_strncat(str_3, "YYEEEEEAHhhh", 6));

  char str_4[10] = "";
  char str_5[10] = "";
  ck_assert_str_eq(strncat(str_4, "YYEEEEEA", 5),
                   s21_strncat(str_5, "YYEEEEEA", 5));
}
END_TEST
